...
def main(_args: List[str] = None):
    ...
    if not 'global' in model_args.head_type:
        if train_args.do_train:
            train_dataset = EEDataset(data_args.cblue_root, "train", data_args.max_length, tokenizer, for_nested_ner=for_nested_ner, augment=plus_parser.augment)
            dev_dataset = EEDataset(data_args.cblue_root, "dev", data_args.max_length, tokenizer, for_nested_ner=for_nested_ner, augment=plus_parser.augment)
    ...
    elif "bert" in model_args.head_type and train_args.layerwise:
